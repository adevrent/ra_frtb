...
wd_PRAM = r"C:/Users/adevr/riskactive_main/FRTB/From_Sait/"  # placeholder, actual file will be uploaded by user
...
date_start = "2025-01-01"  # user input
date_end = "2025-12-31"  # user input

Business_Days = pd.date_range(start=date_start, end=date_end, freq='B')
...
core_deposit_analysis(Report_Core_Deposit, 
                      branch = None, # user input
                      product = "Vadesiz.Mevduat.Ticari", # user input
                      time_bucket = None, # user input
                      currency = 'TRY', # user input
                      freq = 'W', # user input
                      type = 'mean', # user input
                      nsim = 100000,
                      excel = False,
                      plot = True)