...
def _resolve_holidays() -> str:
    ...
    # ---- Legacy default kept for backwards compatibility (optional) ----
    _LEGACY_CORE = r"C:\Users\adevr\riskactive_main\FRTB\From_Sait\Core Analysis\CORE_DEPOSIT_DATA.xlsx"

    core_deposit_filepath = _resolve_path("CORE_DEPOSIT_DATA_PATH", "CORE_DEPOSIT_DATA.xlsx", _LEGACY_CORE)
    ...
    # ... (kullanıcının analiz akışı burada devam eder; fig ve tablolar global isimlerde bırakılır) ...
