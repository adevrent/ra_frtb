...
if __name__ == "__main__":
    ...
    prepayment_filepath = r"C:\Users\adevr\riskactive_main\FRTB\From_Sait\Prepayment Analysis\PREPAYMENT_DATA.xlsx"  # file uploaded by user
...
def data_model(data, data_year_basis = None, start_date = None, end_date = None, Max_Report_Date = None):
