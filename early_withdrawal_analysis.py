...
# early_withdrawal_analysis.py (paths fixed)
import os
import numpy as np
import pandas as pd
import pyreadr
...
early_withdrawal_default = r"C:\Users\adevr\riskactive_main\FRTB\From_Sait\Early Withdrawal Analysis\EARLY_WITHDRAWAL_DATA.xlsx"
early_withdrawal_filepath = _pick_file("EARLY_WITHDRAWAL_DATA_PATH", "EARLY_WITHDRAWAL_DATA.xlsx", early_withdrawal_default)
...
# Load holidays and build calendars
...
# --- original code continues below (unchanged except it now uses Turkey_Holidays/Monthly_Business_Days above) ---
# for filtering
