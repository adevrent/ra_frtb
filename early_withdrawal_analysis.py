    ...
    # early_withdrawal_analysis.py (v2)
...
def _resolve_holidays() -> str:
    ...
    _LEGACY_EWA = r"C:\Users\adevr\riskactive_main\FRTB\From_Sait\Early Withdrawal Analysis\EARLY_WITHDRAWAL_DATA.xlsx"

    early_withdrawal_filepath = _resolve_path("EARLY_WITHDRAWAL_DATA_PATH", "EARLY_WITHDRAWAL_DATA.xlsx", _LEGACY_EWA)
