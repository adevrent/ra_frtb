...
core_deposit_filepath = r"C:\Users\adevr\ra_frtb\data\CORE_DEPOSIT_DATA.xlsx"
...
def core_deposit_analysis(data, 
    ...
    data.dropna(inplace=True)  # VERY IMPORTANT !!
...
table_a, table_b, table_c = core_deposit_analysis(Report_Core_Deposit, 
                      branch = None, 
                      product = None,
                      time_bucket = None,
                      currency = 'TRY',
